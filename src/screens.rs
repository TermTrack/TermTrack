...
pub fn menu(
    ...
    loop {
        ...
        loop {
            ...
            let key_list = if *focused.lock().unwrap(){
...
pub fn leaderboard(level_id: String, level_name: String, focused: Arc<Mutex<bool>>, keys: Arc<Mutex<crate::Keys>>) -> bool {
    let (screen_width, screen_height) = renderer::get_terminal_size();
    let screen_width = screen_width as u16;
    let screen_height = screen_height as u16;
    let box_width = 50;
    ...
    loop {
        ...
        //match input
        loop {
            let key_list = if *focused.lock().unwrap() {keys.lock().unwrap().clone_reset_enter()} else {
                crate::Keys::default()
            };
...
pub fn game_over(arg: &str, focused: Arc<Mutex<bool>>, keys: Arc<Mutex<crate::Keys>>) -> bool {
    let (screen_width, screen_height) = renderer::get_terminal_size();
    let screen_width = screen_width as u16;
    let screen_height = screen_height as u16;
    let (_stream, audio_handle) = OutputStream::try_default().unwrap();
...
pub fn finish(time: f64, level_name: &str, level_map: &str, focused: Arc<Mutex<bool>>, keys: Arc<Mutex<crate::Keys>>) -> u8 {
...
pub fn exit(focused: Arc<Mutex<bool>>, keys: Arc<Mutex<crate::Keys>>) -> bool {
    let (screen_width, screen_height) = renderer::get_terminal_size();
    let screen_width = screen_width as u16;
    let screen_height = screen_height as u16;
